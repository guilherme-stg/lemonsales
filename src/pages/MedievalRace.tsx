...
import joaoAvatar from '@/assets/joao-soldier.png';
...
const AVAILABLE_AVATARS = [matheusAvatar, guilhermeAvatar, brianAvatar, kilsonAvatar, wesleyAvatar, evertonAvatar, tonRockAvatar];
...
function CharacterWithBubble({
  ...
  const isJoao = nomeLower.includes('joão') || nomeLower.includes('joao');
